...
import { bindInput, isSupportedInput, bindAllInputs, processAddedNode } from './InputBinder.js';
...
export function bindAllInputsDeep(root = document) {
  ...
  const directInputs = root.querySelectorAll ? root.querySelectorAll('input, textarea, [contenteditable]') : [];
